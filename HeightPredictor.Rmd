...
The application is running on (https://twan.shinyapps.io/heightpredictor/)

ui.R, and Server.R Code in my github repository (https://github.com/vtwan/Shiny-Application-and-Reproducible-Pitch)
